...
本目录只承接已经退出活动入口、仍需保留的历史 Markdown。
...
| [项目文档 Skill 退出依赖闭包与分层验证收口方案](2026-08-06-DOC-CONSUMER-CLOSURE-20260806-项目文档Skill退出依赖闭包与分层验证收口方案.md) | 记录 skeleton 退出依赖闭包、最小前向夹具、分层验证结论和 consistency 精确兜底的四项决定与实施结果 | [项目术语](../../CONTEXT.md) |
